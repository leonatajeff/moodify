...
export default function Home() {
    ...
    return (
        <div className="generation">
            ...
            {code ? <div>
                    <img style={{ width: 400, height: 400 }} src="https://www.kurin.com/wp-content/uploads/placeholder-square.jpg" alt='placeholding' /> 
                    {console.log(axios.post('/registerToken', responseCode).then(axios.get('/getPrompt')))}
                </div> :
